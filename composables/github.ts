export const useGithub = () => {
  return {
    api: (name: string, type: string) => {
      const cmd = type === 'repo' ? '' : '/repos'
      return useFetch<ResponseItem>(`https://api.github.com/${type}s/${name}${cmd}`, {
        method: 'get',
        query: {
          per_page: 1000,
    ...
    // This is controls the repositories that show up in the carousel and those that are listed on the page.
    //
    // Syntax:
    // {
    //    /**
    ...
    repos: useState('repos', () => [
      ...
      {
        name: 'SEI-TAS/pycloud',
        type: 'repo'
      },
      {
        name: 'SEI-TAS/cloudlet-client',
        type: 'repo'
      },
      {
        name: 'SEI-TAS/client-lib-android',
        type: 'repo'
      },
      {
        name: 'SEI-TAS/client-lib',
        type: 'repo'
      },
      {
        name: 'SEI-TAS/android-logger',
        type: 'repo'
      },
      {
        name: 'SEI-TAS/speech-server',
        type: 'repo'
      },
      {
        name: 'SEI-TAS/speech-android',
        type: 'repo'
      },
      {
      ...
      {
        name: 'cmu-sei/ml-mismatch-descriptors',
        type: 'repo'
      },
      {
        name: 'cmu-sei/TEC',
